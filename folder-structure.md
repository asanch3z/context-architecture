...
Session summaries produced by each instance at session end, following the summary protocol. This is the primary mechanism for context sharing. Each file is named with the instance name and date so any reader can quickly find the latest summary from any instance.
...
1. Create the `/AI_Orchestration/` folder in your Google Drive
